...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KahunaFeedbackPod.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Jitendra Changlani' => 'jitendrachanglani@yahoo.co.in' }
  s.source           = { :git => 'https://github.com/JitendraChanglaniDev/KahunaFeedbackPod.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'KahunaFeedbackPod/Classes/**/*'
  
   s.resource_bundles = {
     'KahunaFeedbackPod' => ['KahunaFeedbackPod/Assets/*.png']
   }
